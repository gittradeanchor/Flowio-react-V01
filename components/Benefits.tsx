    ...
    <div className={`bg-white rounded-md border border-border overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 flex flex-col ${span === 2 ? 'md:col-span-2' : 'md:col-span-1'}`}>
        ...
        <div className={`bg-bg-off border-b border-border h-[240px] md:h-[300px] relative overflow-hidden order-first flex items-center justify-center`}>
            ...
            <div className="hidden absolute inset-0 flex flex-col items-center justify-center text-slate-400 p-4 text-center">
                 ...
                 <div className="font-mono text-xs bg-slate-100 px-2 py-1 rounded border border-slate-200 break-all max-w-[80%]">
                    {imgSrc}
                 </div>
                 <div className="text-xs mt-2 font-bold tracking-wider text-slate-300 uppercase">Image Missing</div>
             </div>
        </div>
