...
export const Hero = () => {
    ...
    return (
        <section className="pt-20 pb-5 md:pt-20 md:pb-12 bg-gradient-to-b from-bg-off to-white">
            ...
            <div className="container mx-auto px-5 max-w-[1100px] flex flex-col items-center md:grid md:grid-cols-[1fr_1.2fr] gap-4 md:gap-12 md:items-center">
                ...
                {/*
                  MOBILE LAYOUT ORDER (CTA above the video so it is in frame on short phones, audit B1.3):
                  1. Eyebrow + Headline + Sub + Price
                  2. CTA + Micro-copy
                  3. Video
                */}
                <div className="contents md:block order-1 md:order-none w-full">
                    ...
                    <div className="text-center md:text-left mb-4 md:mb-6 max-w-[540px] order-2 w-full">
                        ...
                        <p className="text-[13px] md:text-[15px] text-text-muted font-medium leading-relaxed">
                            Done for you · Runs inside the Google Sheet you already quote from · No app to install
                        </p>
                    </div>

                    {/* Price anchor — price and refund always appear together (audit A3.2) */}
                    <p className="text-[13px] text-text-muted font-medium text-center md:text-left mb-4 order-2 w-full max-w-[540px]">
                        <span className="font-bold text-navy">$390</span> inc GST, one-time pilot · 30-day money-back guarantee
                    </p>

                    {/* CTA row */}
                    <div className="flex flex-col items-center md:items-start w-full md:w-auto order-3 md:order-none mt-1 md:mt-0">
                        <div className="flex flex-col sm:flex-row items-center md:items-start gap-3 w-full md:w-auto mb-2">
                            <a href="#test-drive" className="flex items-center justify-center btn w-full sm:w-auto px-6 py-3.5 min-h-[52px] text-base font-bold text-white rounded-xl shadow-btn-primary hover:shadow-lg active:translate-y-0.5 transition-all relative overflow-hidden shine-effect bg-orange hover:bg-orange-hover">
                                Try the 1-minute demo <span className="ml-2 text-2xl leading-[0] pb-1">▸</span>
                            </a>
                        </div>
                ...
                <div className="w-full mb-2 mt-1 md:my-0 order-4 md:order-none">
